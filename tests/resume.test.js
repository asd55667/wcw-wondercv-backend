console.log("Starting resume-api-test");
...
describe("Basic module test", () => {
  ...
  describe("DELETE /resume/basic/:id", () => {
    // console.log(4);
    it("it should to get a delete info", (done) => {
      chai
        .request(server)
        .delete(`/resume/basic/${id}`)
        .set("Authorization", `Bearer ${access_token}`)
        .end((err, res) => {
          res.should.have.status(200);
          done();
